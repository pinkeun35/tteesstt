...
----END RSA PRIVATE KEY-----";
	...
	public function lcidb_insertjajae()
	{
		...
		if ($this->p_session_id != '' && (int)$this->p_session_mtype == 3) {
			...
			if (isset($_POST['jsb'])) {
				$input_data['jsb'] = $this->input->post('jsb', true);
			}
			if (isset($_POST['jcfc'])) {
				$input_data['jcfc'] = $this->input->post('jcfc', true);
			}
			if (isset($_POST['jso'])) {
				$input_data['jso'] = $this->input->post('jso', true);
			}
			if (isset($_POST['jpo'])) {
				$input_data['jpo'] = $this->input->post('jpo', true);
			}
			if (isset($_POST['jhch'])) {
				$input_data['jhch'] = $this->input->post('jhch', true);
			}
			if (isset($_POST['jho'])) {
				$input_data['jho'] = $this->input->post('jho', true);
			}
	...
	public function lcidb_insertenergy()
	{
		...
		if ($this->p_session_id != '' && (int)$this->p_session_mtype == 3) {
			...
			if (isset($_POST['esb'])) {
				$input_data['esb'] = $this->input->post('esb', true);
			}
			if (isset($_POST['ecfc'])) {
				$input_data['ecfc'] = $this->input->post('ecfc', true);
			}
			if (isset($_POST['eso'])) {
				$input_data['eso'] = $this->input->post('eso', true);
			}
			if (isset($_POST['epo'])) {
				$input_data['epo'] = $this->input->post('epo', true);
			}
			if (isset($_POST['ehch'])) {
				$input_data['ehch'] = $this->input->post('ehch', true);
			}
			if (isset($_POST['eho'])) {
				$input_data['eho'] = $this->input->post('eho', true);
			}
	...
	public function lcidb_insertmachine()
	{
		...
		if ($this->p_session_id != '' && (int)$this->p_session_mtype == 3) {
			...
			if (isset($_POST['msb'])) {
				$input_data['msb'] = $this->input->post('msb', true);
			}
			if (isset($_POST['mcfc'])) {
				$input_data['mcfc'] = $this->input->post('mcfc', true);
			}
			if (isset($_POST['mso'])) {
				$input_data['mso'] = $this->input->post('mso', true);
			}
			if (isset($_POST['mpo'])) {
				$input_data['mpo'] = $this->input->post('mpo', true);
			}
			if (isset($_POST['mhch'])) {
				$input_data['mhch'] = $this->input->post('mhch', true);
			}
			if (isset($_POST['mho'])) {
				$input_data['mho'] = $this->input->post('mho', true);
			}
			if (isset($_POST['mcul'])) {
				...
				foreach($sheetData as $key => $val) {
					if ($key > 1) {
						...
						if (isset($sheetData[$key]['E'])) {
							$input_data['jsb'] = $sheetData[$key]['E'];
						}
						if (isset($sheetData[$key]['F'])) {
							$input_data['jcfc'] = $sheetData[$key]['F'];
						}
						if (isset($sheetData[$key]['G'])) {
							$input_data['jso'] = $sheetData[$key]['G'];
						}
						if (isset($sheetData[$key]['H'])) {
							$input_data['jpo'] = $sheetData[$key]['H'];
						}
						if (isset($sheetData[$key]['I'])) {
							$input_data['jhch'] = $sheetData[$key]['I'];
						}
						if (isset($sheetData[$key]['J'])) {
							$input_data['jho'] = $sheetData[$key]['J'];
						}
						if (isset($sheetData[$key]['K'])) {
							$input_data['junit'] = $sheetData[$key]['K'];
						}
						if (isset($sheetData[$key]['L'])) {
							$input_data['jjugi'] = $sheetData[$key]['L'];
						}
						if (isset($sheetData[$key]['M'])) {
							$input_data['jsuseon'] = $sheetData[$key]['M'];
						}
						if (isset($sheetData[$key]['N'])) {
							$input_data['jweight'] = $sheetData[$key]['N'];
						}
						if (isset($sheetData[$key]['O'])) {
							$input_data['jrecycle'] = $sheetData[$key]['O'];
						}
						if (isset($sheetData[$key]['P'])) {
							$input_data['jculceo'] = $sheetData[$key]['P'];
						}
						$input_data['jupdate'] = '';
						if (isset($sheetData[$key]['Q'])) {
							$input_data['jupdate'] = $sheetData[$key]['Q'];
						}
						$input_data['uid'] = $this->p_session_id;
			...
			if ( ! $this->upload->do_upload('excelupload')) {
				...
				foreach($sheetData as $key => $val) {
					if ($key > 1) {
						...
						if (isset($sheetData[$key]['E'])) {
							$input_data['esb'] = $sheetData[$key]['E'];
						}
						if (isset($sheetData[$key]['F'])) {
							$input_data['ecfc'] = $sheetData[$key]['F'];
						}
						if (isset($sheetData[$key]['G'])) {
							$input_data['eso'] = $sheetData[$key]['G'];
						}
						if (isset($sheetData[$key]['H'])) {
							$input_data['epo'] = $sheetData[$key]['H'];
						}
						if (isset($sheetData[$key]['I'])) {
							$input_data['ehch'] = $sheetData[$key]['I'];
						}
						if (isset($sheetData[$key]['J'])) {
							$input_data['eho'] = $sheetData[$key]['J'];
						}
						if (isset($sheetData[$key]['K'])) {
							$input_data['eunit'] = $sheetData[$key]['K'];
						}
						if (isset($sheetData[$key]['L'])) {
							$input_data['eculceo'] = $sheetData[$key]['L'];
						}
						$input_data['eupdate'] = '';
						if (isset($sheetData[$key]['M'])) {
							$input_data['eupdate'] = $sheetData[$key]['M'];
						}
						$input_data['uid'] = $this->p_session_id;
			...
			if ( ! $this->upload->do_upload('excelupload')) {
				...
				foreach($sheetData as $key => $val) {
					if ($key > 1) {
						...
						if (isset($sheetData[$key]['E'])) {
							$input_data['msb'] = $sheetData[$key]['E'];
						}
						if (isset($sheetData[$key]['F'])) {
							$input_data['mcfc'] = $sheetData[$key]['F'];
						}
						if (isset($sheetData[$key]['G'])) {
							$input_data['mso'] = $sheetData[$key]['G'];
						}
						if (isset($sheetData[$key]['H'])) {
							$input_data['mpo'] = $sheetData[$key]['H'];
						}
						if (isset($sheetData[$key]['I'])) {
							$input_data['mhch'] = $sheetData[$key]['I'];
						}
						if (isset($sheetData[$key]['J'])) {
							$input_data['mho'] = $sheetData[$key]['J'];
						}
						if (isset($sheetData[$key]['K'])) {
							$input_data['munit'] = $sheetData[$key]['K'];
						}
						if (isset($sheetData[$key]['L'])) {
							$input_data['mco2'] = $sheetData[$key]['L'];
						}
						if (isset($sheetData[$key]['M'])) {
							$input_data['mculceo'] = $sheetData[$key]['M'];
						}
						$input_data['mupdate'] = '';
						if (isset($sheetData[$key]['N'])) {
							$input_data['mupdate'] = $sheetData[$key]['N'];
						}
						$input_data['uid'] = $this->p_session_id;
